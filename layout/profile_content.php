 ...
 <div class="col-md-4 g-mb-30 g-pl-0 g-pr-0">
    ...
    <figure class="u-info-v7-1 g-brd-around g-brd-gray-light-v4 g-bg-white g-rounded-4 text-center">
      <div class="g-py-40 g-px-20">
        <!-- Figure Image -->
        <div id="profilepic" class="g-width-100 g-height-100 rounded-circle g-mb-20" style="background: url('assets/img/uploads/<?php echo htmlspecialchars($item[0]['picture']); ?>') ;"></div>
        <!-- Figure Image -->

        <!-- Figure Info -->
        <h4 class="h5 mb-4"><?php echo htmlspecialchars($item[0]['username']); ?></h4>
  ...
  <li class="d-flex justify-content-start g-brd-around g-brd-gray-light-v4 g-pa-20 g-mb-minus-1">
    ...
    <div class="align-self-center g-px-10">
      <h5 class="h6 g-font-weight-600 g-color-black g-mb-3">
        <span class="g-mr-5"><?php echo htmlspecialchars($item['listname']); ?></span>
    ...
    <?php 
      ...
      if (!empty($exist = $foreigns->followExists($item['listsID']))) {
          echo ' <div class="align-self-center ml-auto"><a href="#">
          <span class="u-icon-v1 g-color-red"><i data-id="' . $item['listsID'] . '" id="broken" class="followbutton fa fa-chain-broken u-line-icon-pro u-line-icon-pro"></i></span>
          </a>
    </div>';          
      } else {
          
         echo ' <div class="align-self-center ml-auto"><a href="#">
          <span class="u-icon-v1 g-color-primary"><i data-id="' . $item['listsID'] . '" id="followed" class="followbutton fa fa-link u-line-icon-pro u-line-icon-pro"></i></span>
          </a>
    </div>'; 
      }
      ?>
